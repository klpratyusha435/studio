...
export default function CheckoutPage() {
  ...
  const cafeRef = useMemoFirebase(() => (firestore && cart?.cafeId ? doc(firestore, 'cafes', cart.cafeId) : null), [firestore, cart?.cafeId]);
  ...
  const handlePlaceOrder = (formData: CheckoutFormValues) => {
    ...
    const orderData = {
      ...
      deliveryLocation: formData.deliveryMode === 'delivery' && formData.deliveryLocationType && formData.deliveryLocationLabel ? {
  ...
  return (
    <div className="container mx-auto p-4 sm:p-8 max-w-4xl">
      ...
      <form onSubmit={form.handleSubmit(handlePlaceOrder)} className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div>
          <Card>
            <CardHeader>
              ...
              {deliveryMode === 'delivery' && (
                <div className="space-y-4 rounded-md border p-4">
                  ...
                  <div className="space-y-2">
                   ...
                   {form.formState.errors.deliveryLocationLabel && <p className="text-sm font-medium text-destructive">{form.formState.errors.deliveryLocationLabel.message}</p>}
                </div>
              )}
            </CardContent>
          </Card>
